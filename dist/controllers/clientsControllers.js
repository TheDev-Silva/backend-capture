...
const createClient = (request, reply) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const newClient = yield prisma.captureClient.create({
...
const getClients = (request, reply) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const clients = yield prisma.captureClient.findMany({
...
const getRegisteredStats = (request, reply) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const status = yield prisma.captureClient.groupBy({
            by: ['status', 'createdAt'],
            _count: {
                id: true,
            },
